...
public class Joystick : MonoBehaviour, IDragHandler, IPointerUpHandler, IPointerDownHandler
{
    ...
    public void OnDrag(PointerEventData eventData)
    {
        ...
        input = new Vector2((eventData.position - outLine.anchoredPosition).x / (radius * canvas.scaleFactor).x - 6.4f, (eventData.position - outLine.anchoredPosition).y / (radius * canvas.scaleFactor).y - 3.5f);
